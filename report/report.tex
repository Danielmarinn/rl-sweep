...
$\lfloor T/10 \rfloor$ steps (10 episodes each).
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{../results/plots/04_gamma_lr_lunar.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{../results/plots/05_acrobot_collapse.png}
